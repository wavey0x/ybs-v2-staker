    ...
    contract SwapperV4 {
        ...
        modifier isAllowedSwapper() {
            require(
                ...
                allowedSwapper[msg.sender], "!AllowedSwapper"
            );
            _;
        }
        ...
        modifier onlyOwnerOrManagement() {
            require(msg.sender == owner || msg.sender == management, "!ownerOrManagement");
            _;
        }
        ...
        function _sellOtc(uint _sellTokenAmount) internal isAllowedSwapper returns (uint, uint) {
        ...
        function setAllowedSwapper(address _caller, bool _isAllowed) external onlyOwnerOrManagement {
